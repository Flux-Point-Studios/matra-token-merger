#!/usr/bin/env bash
# =============================================================================
# Deterministic Build Verification for cMATRA Surrender Pool Validator
# =============================================================================
#
# This script allows anyone to independently verify that the deployed validator
# matches the audited source code.  It rebuilds the validator from source and
# compares the resulting script hash against the expected value.
#
# Prerequisites:
